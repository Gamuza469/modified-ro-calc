...
JobHP_Third = [
/* RK */[8100,8133,8242,8352,8464,8576,8690,8804,8920,9036,9154,9273,9393,9514,9636,9759,9883,10008,10134,10261,10389,10518,10648,10779,10912,11045,11180,11315,11452,11589,11728,11868,12009,12151,12294,12438,12583,12729,12876,13024,13173,13323,13474,13626,13780,13934,14090,14246,14404,14562,14722,14883],
...
/* WL */[3200,3313,3383,3455,3528,3601,3675,3749,3824,3899,3975,4051,4129,4208,4287,4367,4447,4528,4609,4691,4773,4857,4941,5026,5112,5198,5285,5372,5460,5548,5638,5728,5819,5911,6003,6096,6189,6283,6377,6473,6569,6666,6763,6861,6960,7059,7159,7259,7361,7463,7566,7669],
/* ME */[5807,5844,5952,6061,6172,6283,6396,6510,6625,6741,6857,6974,7093,7212,7333,7455,7578,7702,7828,7954,8081,8208,8337,8467,8598,8730,8864,8998,9134,9271,9408,9546,9685,9825,9967,10109,10253,10398,10544,10691,10838,10987,11136,11287,11439,11592,11746,11901,12057,12215,12372,12531],
...
/* SO */[4080,4103,4180,4257,4335,4414,4494,4574,4655,4737,4819,4902,4986,5071,5157,5244,5332,5420,5509,5599,5689,5780,5872,5965,6058,6153,6248,6344,6441,6539,6637,6737,6837,6937,7038,7140,7243,7347,7451,7557,7663,7770,7878,7987,8097,8207,8318,8429,8541,8654,8768,8883],
...
/* KO */[3994,4074,4155,4237,4319,4402,4486,4571,4657,4743,4830,4918,5007,5097,5187,5278,5370,5463,5557,5651,5746,5842,5939,6037,6135,6234,6334,6437,6537,6639,6742,6846,6951,7057,7163,7270,7378,7487,7597,7707,7818,7930,8043,8157,8271,8386,8502,8619,8737,8855,8974,9094],
...
//            }
		...
		if (n_A_BaseLV > 150) {
		    n_A_MaxHP = Math.floor(35 + n_A_BaseLV * HP_COEFF[Math.floor( n_A_JOB / 2 ) - 23][1]/100 + k)
		} else {
...
/* KO*/[522,530,538,546,554,562,570,578,586,594,602,610,618,626,634,642,650,658,666,674,682,690,698,706,714,722,730,738,746,754,762,770,778,786,794,802,810,818,826,834,842,850,858,866,874,882,890,898,906,914,922,930]
];
var SP_COEFF = [
/* WL, SO, GE */
/* AB */
...
function calcSP( n_A_MaxSP )
{
	...
	{ // Non-3rd class
		...
		if (n_A_JOB === cls_KAGOB) {
                    n_A_MaxSP = 522 + (8 * (n_A_BaseLV - 99));
                }
	}
	else
	{ // 3rd Class
		if (n_A_BaseLV > 150) {
		    n_A_MaxSP = Math.floor(10 + SP_COEFF[Math.floor(n_A_JOB/2)-23]*n_A_BaseLV/100.0);
		} else {
...
function calcHardDef( n_A_totalDEF )
{
	...
	if (otherBuffs[ksOdinsPower] >= 1) { //Odin's Power
		n_A_DEF -= 20*otherBuffs[ksOdinsPower];
	}
...
function calcHardMDef(n_A_MDEF)
{
	...
	if (otherBuffs[ksOdinsPower] >= 1) { //Odin's Power
		n_A_MDEF -= 20*otherBuffs[ksOdinsPower];
	}
	// Equipment modifiers
	if ( EquipNumSearch( 872 ) )
	{ // Crown of Deceit
